...
ActiveRecord::Schema.define(version: 20151111031717) do
  ...
  create_table "salaray_ranges", force: :cascade do |t|
    t.float    "min_salary"
    t.float    "max_salary"
    t.integer  "job_id"
    t.datetime "created_at", null: false
  ...
  add_index "salaray_ranges", ["job_id"], name: "index_salaray_ranges_on_job_id"
